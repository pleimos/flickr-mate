...
NSString *SRCallbackURLBaseString = @"flickrmate://auth";
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    NSString *thumbnailPath = [tempPath stringByAppendingPathComponent:@"thumbnail"];
    if( [[NSFileManager defaultManager] fileExistsAtPath:thumbnailPath] == NO ){
        [[NSFileManager defaultManager] createDirectoryAtPath:thumbnailPath withIntermediateDirectories:YES attributes:nil error:nil];
    }
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"MateModel" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"MateModel.sqlite"];
